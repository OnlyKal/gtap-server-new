...
from .views import CancelDemandeView, ChangePasswordView, CreateDemandeView, PaiementCreateView, ServiceListView, SignUpView, LoginView, UserDetailView,PaiementListView
